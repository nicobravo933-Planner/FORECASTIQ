...
| 2026-05-22 | 41      | UX-5 rediseño visual: theme.ts → paleta dark navy fintech (#070d1b/#0d1625) + glassmorphism en Card/Paper/Drawer/AppBar/Button/Chip/Alert/Menu/Fab. layout.tsx → sidebar colapsable 15rem↔4rem (botón toggle ChevronLeft/Right, tooltips en modo collapsed), header global con fecha + notificaciones + avatar. Radial glow en main content. |
