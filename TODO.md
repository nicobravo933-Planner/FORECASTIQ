...
| 2026-05-21 | 34      | EC2 aligerado: docker-compose.prod.yml creado (override: celery_worker + celery_beat con replicas:0 en prod). deploy.yml actualizado. CORS_ORIGINS seteado en backend/.env EC2. Mixed-content resuelto via rewrites vercel.json (proxy /backend/* → EC2). Fix structlog add_logger_name incompatible con PrintLoggerFactory. Calendario ✅ Feriados AR ✅ MLOps ✅ sin errores. Puerto 8000 abierto en Security Group AWS. |
