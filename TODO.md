...
| 2026-05-24 | 63      | README + ROADMAP actualizados: Cloudflare R2 badge + storage demo, migraciones 004-006 en quick start, tabla features actualizada. ROADMAP: Parquet en R2 documentado, tiers tabla, auth estado, backlog fuentes de datos. |
