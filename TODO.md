...
| 2026-05-23 | 62      | Chip tier colapsado: modo circular 2rem con Tooltip "Backend local" al hover. EC2: SERVER_TIER=ec2 en backend/.env, imagen pendiente de rebuild via CI/CD. useCapabilities normaliza tier_label desde tier cuando el backend no lo devuelve (compatibilidad imagen vieja). |
