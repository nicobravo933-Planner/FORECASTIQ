...
| 2026-05-22 | 42      | Fixes visuales: (1) bg menos negro #0b1120. (2) Logo sidebar 200×44. (3) chat/page height calc corregido para header. (4) FloatingChat: burbuja 28×30rem, sin WelcomeScreen, FAB robot Lottie + pulso verde online + badge unread. (5) RobotAvatar prop transparent (sin fondo circular). (6) Colores azul navy actualizados en glass tokens. |
