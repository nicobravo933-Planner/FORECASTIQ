...
| 2026-05-21 | 34      | EC2 aligerado: docker-compose.prod.yml creado (override: celery_worker + celery_beat con replicas:0 en prod). deploy.yml actualizado para usar -f docker-compose.prod.yml en SSH deploy. Pendiente: CORS_ORIGINS en .env EC2 + NEXT_PUBLIC_API_URL en Vercel. |
