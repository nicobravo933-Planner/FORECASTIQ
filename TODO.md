...
| 2026-05-23 | 45      | Chat UX polish: (1) Sidebar toggle con HistoryIcon en header del chat — azul cuando abierto, gris cuando cerrado. (2) MessageBubble user bubble: botones Copiar/Editar/Reenviar aparecen en hover, se ocultan al salir. Editar pone el texto en el input, Reenviar lo manda directo. (3) Rate limit fix: X-Forwarded-For para IP real detrás de proxies, CHAT_RATE_LIMIT subido 30→60. |
