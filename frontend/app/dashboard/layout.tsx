  ...
  return (
    <Box sx={{ display: "flex", minHeight: "100vh", bgcolor: "background.default" }}>
      ...
      >
        ...
        <Divider sx={{ borderColor: "divider" }} />
        <Box sx={{ px: "1rem", py: "0.875rem", display: "flex", alignItems: "center", gap: "0.75rem" }}>
          <Tooltip title={user ? `${user.email}` : "Sin sesión"} placement="top">
            <IconButton onClick={(e) => setAnchorEl(e.currentTarget)} sx={{ p: 0 }}>
              <Avatar
                src={user?.image ?? undefined}
                sx={{ width: "2rem", height: "2rem", fontSize: "0.75rem", bgcolor: "primary.main" }}
              >
                {initials}
              </Avatar>
            </IconButton>
          ...
          <Box sx={{ overflow: "hidden" }}>
            ...
            <Typography variant="caption" color="text.disabled" noWrap display="block" sx={{ fontSize: "0.65rem" }}>
